...
from aoe2mapgenerator.scenario.gate import get_gate_x_shift, get_gate_y_shift
from aoe2mapgenerator.common.enums.enum import GateObject
from aoe2mapgenerator.map.maplayer import MapLayerDictionary
